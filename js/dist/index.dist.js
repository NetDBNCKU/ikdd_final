...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Chart, null), document.getElementById("chart"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Circles = __webpack_require__(160);
	module.exports = React.createClass({
	    ...
	    changeFile: function changeFile(filename) {
	    ...
	    circleOnMouseOver: function circleOnMouseOver(e) {
	        this.stopInterval();
	        this.setState({
	            showCity: e.target.getAttribute('id')
	        });
	    },
	    circleOnMouseOut: function circleOnMouseOut() {
	        this.startInterval();
	    },
	    value: function value() {
	        if (this.state.x_axis_data.length > 0 && this.state.showCity != undefined) {
	            return this.state.x_axis_data[Math.floor(this.state.year) - 1998][this.state.showCity];
	        }
	    },
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'svg',
	                { id: 'svg', width: this.props.width, height: this.props.height },
	                React.createElement(
	                    'g',
	                    { id: 'yAxis',
	                ...
	                React.createElement(Circles, _extends({}, this.state, {
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'select',
	                    { className: 'ui dropdown', defaultValue: 'annual_income.csv' },
	                    React.createElement(
	                        'option',
	                        { value: 'annual_income.csv' },
	                        '歲入'
	                    ),
	                    React.createElement(
	                        'option',
	                        { value: 'labor_force.csv' },
	                        '勞動力'
	                    ),
	                    React.createElement(
	                        'option',
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	    ...
	    computeData: function computeData(dataArr, year) {
	    ...
	    circle: function circle() {
	        ...
	        return props.cityArr.map(function (city_name) {
	            ...
	            if (isNaN(yVal) || isNaN(xVal) || isNaN(populationVal)) {} else {
